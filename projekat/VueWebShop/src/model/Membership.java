...
public class Membership {
	...
	public Membership(String id, String typeMembership, LocalDate dayPaying, double value, LocalDate startValidation,
			LocalDate endValidation, MembershipStatus membershipStatus, double numberOfTerms, String sendPoints,
	...
	public Membership(String id, String typeMembership, LocalDate dayPaying, double value, LocalDate startValidation,
			LocalDate endValidation, MembershipStatus membershipStatus, double numberOfTerms) {
		super();
		this.id = id;
		this.typeMembership = typeMembership;
		this.dayPaying = dayPaying;
